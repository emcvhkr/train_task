...
NToolButton::NToolButton(QString pic_name, QWidget *parent)
    :QToolButton(parent)
{
    //设置文本颜色
...
void NToolButton::enterEvent(QEvent *)
{
    mouse_hover = true;
}

void NToolButton::leaveEvent(QEvent *)
{
    mouse_hover = false;
}
...
void NToolButton::setMousePress(bool mouse_press)
{
...
void NToolButton::painterInfo(int top_color, int middle_color, int bottom_color)
{
