...
{
    skin_list<<":/img/skin/0_p"<<":/img/skin/1_p"<<":/img/skin/2_p"<<":/img/skin/3_p"<<":/img/skin/4_p"<<
        ":/img/skin/5_p"<<":/img/skin/6_p"<<":/img/skin/7_p"<<":/img/skin/8_p"<<":/img/skin/9_p"<<
        ":/img/skin/10_p"<<":/img/skin/11_p"<<":/img/skin/12_p"<<":/img/skin/13_p"<<":/img/skin/14_p"<<
        ":/img/skin/15_p"<<":/img/skin/16_p"<<":/img/skin/17_p"<<":/img/skin/18_p"<<":/img/skin/19_p"<<
        ":/img/skin/20_p"<<":/img/skin/21_p"<<":/img/skin/22_p"<<":/img/skin/23_p";
...
void SkinWidget::showSkin(QString current_skin)
{
    ...
    change_skin_widget_0->changeSkin(":/img/skin/"+ QString::number(previous_total_page++, 10), tip_list.at(tip_index++), "11");
    //change_skin_widget_0->changeSkin(":/img/skin/17_p", tip_list.at(tip_index++), "11");
    change_skin_widget_1->changeSkin(":/img/skin/"+ QString::number(previous_total_page++, 10), tip_list.at(tip_index++), "11");
    change_skin_widget_2->changeSkin(":/img/skin/"+ QString::number(previous_total_page++, 10), tip_list.at(tip_index++), "11");
    change_skin_widget_3->changeSkin(":/img/skin/"+ QString::number(previous_total_page++, 10), tip_list.at(tip_index++), "11");
    change_skin_widget_4->changeSkin(":/img/skin/"+ QString::number(previous_total_page++, 10), tip_list.at(tip_index++), "11");
    change_skin_widget_5->changeSkin(":/img/skin/"+ QString::number(previous_total_page++, 10), tip_list.at(tip_index++), "11");
    change_skin_widget_6->changeSkin(":/img/skin/"+ QString::number(previous_total_page++, 10), tip_list.at(tip_index++), "11");
    change_skin_widget_7->changeSkin(":/img/skin/"+ QString::number(previous_total_page++, 10), tip_list.at(tip_index++), "11");
}
