    ...
    :QWidget(parent)
{
    ...
    skin_button = new NPushButton();
    main_menu_button = new NPushButton();
    min_button = new NPushButton();
    max_button = new NPushButton();
    ...
    //设置图片
    skin_button->loadPixmap(":/img/sysButton/skin_button_p");
    main_menu_button->loadPixmap(":/img/sysButton/main_menu_p");
    min_button->loadPixmap(":/img/sysButton/min_button_p");
    max_button->loadPixmap(":/img/sysButton/max_button_p");
    close_button->loadPixmap(":/img/sysButton/close_button_p");

    QIcon medal_icon(":/img/contentWidget/medal_p");
    ...
    string_list<<":/img/toolWidget/tiJian_p"<<":/img/toolWidget/muMa_p"<<":/img/toolWidget/louDong_p"<<":/img/toolWidget/xiTong_p"
        <<":/img/toolWidget/qingLi_p"<<":/img/toolWidget/jiaSu_p"<<":/img/toolWidget/menZhen_p"<<":/img/toolWidget/ranJian_p";
    ...
    {
        NToolButton *tool_button = new NToolButton(string_list.at(i));
    ...
    QPixmap pixmap(":/img/logo/logo_p");
...
void TitleWidget::turnPage(QString current_page)
{
    ...
    {
        NToolButton *tool_button = button_list.at(i);
        if(current_index == i)
        {
