...
void ContentWidget::initLeft()
{
    ...
    QPixmap label_pixmap(":/img/contentWidget/computer_p");
    ...
    QPixmap pixmap(":/img/contentWidget/power_p");
...
void ContentWidget::initRightCenter()
{
    ...
    //设置图标
    QPixmap fireproof_pixmap(":/img/contentWidget/fireproof_p");
    ...
    QPixmap triggerman_pixmap(":/img/contentWidget/triggerman_p");
    ...
    QPixmap net_shop_pixmap(":/img/contentWidget/net_shop_p");
...
void ContentWidget::initRightCenterFunction()
{
    ...
    QPixmap recovery_pixmap(":/img/contentWidget/recover_p");
    ...
    QPixmap mobile_pixmap(":/img/contentWidget/mobile_p");
    ...
    QPixmap game_box_pixmap(":/img/contentWidget/game_box_p");
    ...
    QPixmap desktop_pixmap(":/img/contentWidget/desktop_p");
    ...
    QPixmap net_repair_pixmap(":/img/contentWidget/repair_p");
    ...
    QPixmap auto_run_pixmap(":/img/contentWidget/auto_run_p");
    ...
    QPixmap net_speed_pixmap(":/img/contentWidget/net_speed_p");
    ...
    QPixmap net_pretext_pixmap(":/img/contentWidget/net_pretext_p");
    ...
    QPixmap first_add_pixmap(":/img/contentWidget/first_add_p");
...
void ContentWidget::initRightBottom()
{
    ...
    QPixmap label_pixmap(":/img/contentWidget/cloud_p");
    icon_label->setPixmap(label_pixmap);
    icon_label->setFixedSize(label_pixmap.size());

    QPixmap pixmap(":/img/contentWidget/version_p");
